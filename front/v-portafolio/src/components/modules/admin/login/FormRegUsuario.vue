<template>
    <div class="form-register">
      ...
      <div class="content-form">
        <FormGroup>
          ...
          <GroupInput>
            <SelectForm v-model="tipoIdentificacion" :options="tipoIdentificacionOptions" label="Tipo de Identificación" :error="errors.tipoIdentificacion" />
          </GroupInput>
          <GroupInput>
            <InputForm v-model="identificacion" :error="errors.identificacion" type="number">Número de Identificación</InputForm>
          </GroupInput>
          <GroupInput>
            <InputForm v-model="direccion" :error="errors.direccion">Dirección</InputForm>
          </GroupInput>
          <GroupInput>
            <InputForm v-model="correoElectronico" :error="errors.correoElectronico" type="email">Correo Electrónico</InputForm>
          </GroupInput>
          <GroupInput>
  ...
  import SelectForm from '@/components/shared/forms/SelectForm.vue';
